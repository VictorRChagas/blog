...
public class AuthorTest {
    ...
    private static final String AUTHOR_MAIL = "gasparbarancelli@gmail.com";
    ...
    public void createNewAuthorByBuilder() {
        var author = Author.builder(AUTHOR_NAME, AUTHOR_MAIL)
        ...
        Assertions.assertEquals(AUTHOR_MAIL, author.getMail());
    ...
    public void uniqueByName() {
        var author1 = Author.builder(AUTHOR_NAME, AUTHOR_MAIL).build();
        var author2 = Author.builder(AUTHOR_NAME, AUTHOR_MAIL).build();
